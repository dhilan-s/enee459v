...
uint16_t sampleServHandle, buttonServHandle, TXCharHandle, RXCharHandle, buttonCharHandle;
...
void sendButton(uint8_t* state){
	aci_gatt_update_char_value(buttonServHandle,buttonCharHandle, 0, 1, state);
}
