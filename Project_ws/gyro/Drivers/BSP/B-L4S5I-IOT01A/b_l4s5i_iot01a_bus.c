...
/**
  ...
  * @retval BSP status
  */
__weak int32_t BSP_I2C2_Init(void)
{
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t BSP_I2C2_DeInit(void)
{
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t BSP_I2C2_IsReady(uint16_t DevAddr, uint32_t Trials)
{
  int32_t ret = BSP_ERROR_NONE;
...
__weak int32_t BSP_I2C2_WriteReg(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length)
{
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t  BSP_I2C2_ReadReg(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length)
{
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP statu
  */
__weak int32_t BSP_I2C2_WriteReg16(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length)
{
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t  BSP_I2C2_ReadReg16(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length)
{
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t BSP_I2C2_Send(uint16_t DevAddr, uint8_t *pData, uint16_t Length) {
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
__weak int32_t BSP_I2C2_Recv(uint16_t DevAddr, uint8_t *pData, uint16_t Length) {
  int32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  */
__weak int32_t BSP_GetTick(void) {
  return HAL_GetTick();
}
